...
# Load data
data_train = pd.read_csv("features_csv_files/ResNet101_features_LSTM.csv", header=None) # Need to give the path to the file
label_train = pd.read_csv("label1.csv", header=None)
